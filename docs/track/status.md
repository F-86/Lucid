...
- [x] **撤销/重做系统** (History 模块 + UI 集成) ✓
- [x] **快捷键框架** (Keybinding 模块 + 按钮状态) ✓

待做：
- [ ] 全局快捷键捕获 (集成 iced 事件系统)
- [ ] 快捷键配置持久化
...
- pulldown-cmark 0.12 ✓ (Parser 框架完成)
- thiserror 2 ✓
- tokio 1 ✓ (异步 I/O 完成)
- serde 1
- rfd 0.15 ✓ (文件对话框完成)
